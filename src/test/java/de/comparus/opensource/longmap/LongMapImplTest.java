...
public class LongMapImplTest {
	...
	public void init() {
		...
		_map.put(12, "Heinlein");
		_map.put(21, "Asimov");
		_map.put(524, "Bradbury");
		_map.put(17, "Lem");
		_map.put(163, "Verne");
	...
	public void isSizeChangedAfterRemovingByExistingKey() {
		...
		Assert.assertEquals("Map's size didn't change after operation "
...
//	 */
//	@SuppressWarnings("unchecked")
//	public LongMapImplTest(int initialCapacity) {
...
//	 */
//	@SuppressWarnings("unchecked")
//	public LongMapImplTest(int initialCapacity, boolean doDecreasing) {
//		checkInitCapcity(initialCapacity);
//		this._capacity = initialCapacity;
//		this._entries = new Entry[initialCapacity];
